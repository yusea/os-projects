...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    106e:	50                   	push   %eax
    106f:	68 43 18 00 00       	push   $0x1843
    1074:	6a 02                	push   $0x2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1412:	0f b6 80 b4 1a 00 00 	movzbl 0x1ab4(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    154e:	75 25                	jne    1575 <printf+0xff>
          s = "(null)";
    1550:	c7 45 f4 5f 18 00 00 	movl   $0x185f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1616:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16e1:	a3 d0 1a 00 00       	mov    %eax,0x1ad0
}
    16e6:	90                   	nop
    16e7:	c9                   	leave  
    16e8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1742:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
}
    1747:	c9                   	leave  
    1748:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    175e:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
    1763:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1766:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    176a:	75 23                	jne    178f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    176c:	c7 45 f0 c8 1a 00 00 	movl   $0x1ac8,-0x10(%ebp)
    1773:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1776:	a3 d0 1a 00 00       	mov    %eax,0x1ad0
    177b:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
    1780:	a3 c8 1a 00 00       	mov    %eax,0x1ac8
    base.s.size = 0;
    1785:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
    178c:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17e2:	a3 d0 1a 00 00       	mov    %eax,0x1ad0
      return (void*)(p + 1);
    ...
    if(p == freep)
    17ef:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
